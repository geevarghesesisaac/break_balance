...
<button id="theme-toggle" aria-label="Toggle theme"
    ...
    <!-- Sun Icon -->
    <svg id="moon-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none" viewBox="0 0 30 30" style="display:none;">
    ...
    <svg id="sun-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="none" viewBox="0 0 26 26">
